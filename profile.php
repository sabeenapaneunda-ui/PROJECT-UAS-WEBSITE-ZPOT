...
<body>
    ...
    <div class="container mt-40">
        ...
        <div class="profile-tabs">
            <a href="profile.php" class="tab-link active">PROFILE</a>
        ...
        <div class="profile-section">
            ...
            <div class="review-long-card">
                <div class="review-thumb-box">
                    <img src="images/profile/nannys pavillon.webp" alt="Nannys Pavillon">
                </div>
                <div class="review-content">
            ...
            <div class="review-long-card">
                <div class="review-thumb-box">
                    <img src="images/profile/the acre.webp" alt="The Acre">
                </div>
                <div class="review-content">
            ...
            <div class="review-long-card">
                <div class="review-thumb-box">
                    <img src="images/profile/hutankota.webp" alt="Hutan Kota GBK">
                </div>
                <div class="review-content">
        ...
        <div class="profile-section popular-reviews-section">
            <div class="profile-section-header">
            ...
            <div class="review-long-card">
                <div class="review-thumb-box">
                    <img src="images/index/DreamDates_Photo.png" alt="Dream Dates">
                </div>
                <div class="review-content">
            ...
            <div class="review-long-card">
                <div class="review-thumb-box">
                    <img src="images/index/Sentosa-Senayan.webp" alt="Sentosa Senayan">
                </div>
                <div class="review-content">
    ...
    <script>
        ...
        function toggleSettings(event) {
            ...
            const a = document.getElementById('accountPopup');
        ...
        window.addEventListener('click', function(e) {
            ...
            if (s && a) {
                if (!s.contains(e.target) && !a.contains(e.target) && !b.contains(e.target)) {
