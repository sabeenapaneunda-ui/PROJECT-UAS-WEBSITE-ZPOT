    ...
    <div class="container mt-40">
        ...
        <div class="profile-header-wrapper">
            <div class="profile-avatar-large" style="overflow: hidden; padding: 0; border: none;">
                <img src="images/profile/profile.png" alt="Glinda Upland" style="width: 100%; height: 100%; object-fit: cover;">
            </div>
        ...
        <div class="profile-tabs">
            ...
            <a href="profile-favorites.php" class="tab-link active">FAVORITES</a>
        </div>
        ...
        <div class="profile-section">
            ...
            <div class="favorites-grid">
                ...
                <div class="fav-box">
                    <img src="images/profile/tuku.webp" alt="Kopi Tuku">
                    <div class="heart-icon-circle">
                        <i class="fas fa-heart" style="color: #5E2C0E;"></i>
                    </div>
                </div>

                <div class="fav-box">
                    <img src="images/profile/tiramisu.jpg" alt="Tiramisu">
                    <div class="heart-icon-circle">
                ...
                <div class="fav-box">
                    <img src="images/profile/teazzi.webp" alt="Teazzi">
                    <div class="heart-icon-circle">
                        <i class="fas fa-heart" style="color: #5E2C0E;"></i>
                    </div>
                </div>
                ...
                <div class="fav-box">
                    <img src="images/profile/honest spoon.webp" alt="Honest Spoon">
                    <div class="heart-icon-circle">
                        <i class="fas fa-heart" style="color: #5E2C0E;"></i>
                    </div>
                </div>
