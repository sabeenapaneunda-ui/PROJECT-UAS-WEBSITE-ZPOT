                ...
                <div class="scroll-container">
                    <?php for ($i = 0; $i < 6; $i++): ?>
                        <div class="place-card-brown" onclick="openPlaceModal()" style="cursor: pointer;">
                            <img src="images/index/LOGO ZPOT.png" class="place-thumb-img" style="object-fit: contain; background: #f0f0f0;" alt="Thumbnail">
            ...
            <div class="review-details-grid">
                ...
                <div class="details-left-col">
                    ...
                    <div class="tanatap-photo-grid">
                        <div class="grid-item main-pic" style="background:#ddd;"></div>
                        <div class="grid-item top-right" style="background:#ddd;"></div>
                        <div class="grid-item mid-right" style="background:#ddd;"></div>
                        <div class="grid-item bottom-left" style="background:#ddd;"></div>
                        <div class="grid-item bottom-mid" style="background:#ddd;"></div>
                    </div>
                    ...
                    <div class="tanatap-info-box">
                        <div class="info-text-col">
                            ...
                            <div class="info-row">
                                ...
                                <span style="text-decoration: underline;">0812-XXXX-XXXX</span>
                            </div>
                            <div class="info-row">
                ...
                <div class="details-right-col">
                    ...
                    <div class="rd-box location-box">
                        <h3>Location</h3>
                        <div class="map-link-wrapper" style="background: #eee; height: 150px; display:flex; align-items:center; justify-content:center;">
                            Map Placeholder
                        </div>
                        <div class="map-address-text">Address details...</div>
                    </div>

                    <div class="rd-box related-reviews-box">
                        <h3>Related Reviews</h3>
                        <p style="padding: 10px; color: #666;">No related reviews yet.</p>
                    </div>
