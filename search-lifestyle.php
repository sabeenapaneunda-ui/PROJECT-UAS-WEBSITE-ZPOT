...
<body>
    ...
    <div class="search-tag-pill">
        <i class="fas fa-map-marker-alt"></i> <span>Place</span>                 </div>
    ...
    <div style="flex: 1;"></div> 
        ...
        <div class="horizontal-section">
            ...
            <div class="scroll-container">
                <div class="place-card-brown" onclick="openPlaceModal()" style="cursor: pointer;"><div class="place-thumb"></div><div class="place-info"><h4>Keterangan Nama</h4><div class="addr">alamat</div><div class="by">by : @username</div></div></div>
                <div class="place-card-brown" onclick="openPlaceModal()" style="cursor: pointer;"><div class="place-thumb"></div><div class="place-info"><h4>Keterangan Nama</h4><div class="addr">alamat</div><div class="by">by : @username</div></div></div>
                <div class="place-card-brown" onclick="openPlaceModal()" style="cursor: pointer;"><div class="place-thumb"></div><div class="place-info"><h4>Keterangan Nama</h4><div class="addr">alamat</div><div class="by">by : @username</div></div></div>
                <div class="place-card-brown" onclick="openPlaceModal()" style="cursor: pointer;"><div class="place-thumb"></div><div class="place-info"><h4>Keterangan Nama</h4><div class="addr">alamat</div><div class="by">by : @username</div></div></div>
                <div class="place-card-brown" onclick="openPlaceModal()" style="cursor: pointer;"><div class="place-thumb"></div><div class="place-info"><h4>Keterangan Nama</h4><div class="addr">alamat</div><div class="by">by : @username</div></div></div>
    ...
    // 3. Tutup jika klik di luar kotak
    window.onclick = function(event) {
        ...
        // --- 1. LOGIKA POP-UP MODAL (JANGAN DIHAPUS) ---
        ...
        // --- 2. LOGIKA SCROLL DENGAN PANAH (INI YANG BARU) ---
        function scrollHorizontal(btn, direction) {
            // Cari container terdekat dari tombol yang diklik
        ...
        function toggleSettings(event) {
            ...
            // Tutup account popup jika sedang terbuka biar tidak numpuk
        ...
        function openAccountPopup(event) {
            event.preventDefault(); // Mencegah link pindah halaman
            document.getElementById('settingsDropdown').style.display = 'none'; // Tutup menu utama
            document.getElementById('accountPopup').style.display = 'block';   // Buka menu account
        }

        function closeAccountPopup() {
            document.getElementById('accountPopup').style.display = 'none';
            document.getElementById('settingsDropdown').style.display = 'block'; // Balik ke menu utama
        }

        // Fungsi Menutup Pop-up jika klik di luar kotak
        window.addEventListener('click', function(e) {
            ...
            if (settingsPopup && accountPopup) {
                // Cek apakah yang diklik BUKAN bagian dari pop-up atau tombol menu
